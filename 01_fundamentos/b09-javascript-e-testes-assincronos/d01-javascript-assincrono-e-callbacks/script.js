...
// Resposta no arquivo script.test.js
...
const logDetails = (error, message) => {
  if (error) {
    console.log(error);
  } else {
    console.log(message);
...
getPokemonDetails((pokemon) => pokemon.name === 'Bulbasaur', logDetails);
